...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "737907f4ed3a71f6ec12638387aff7cda4764f8c2eb18deeca16e2fb7ed66c9f";
  };

  buildInputs = with pkgs; [ readline pam openldap popt iniparser libunwind fam acl cups python perl ]
    ++ stdenv.lib.optional useKerberos kerberos;

  enableParallelBuilding = true;

  # source4/configure no longer exists with this version
  # postPatch =
  #   # XXX: Awful hack to allow cross-compilation.
  #   '' sed -i source4/configure \
